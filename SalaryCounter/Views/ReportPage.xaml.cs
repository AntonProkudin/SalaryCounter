...
public partial class ReportPage : ContentPage
{
    ...
    protected override void OnAppearing()
    {
        ...
        pickerCommand.Items.Add("Генерация предположительных трудозатрат");
        pickerCommand.Items.Add("Генерация предположительных трудозатрат по задаче");
        ...
        chart.Source = "C:\\Users\\anton\\Desktop\\otchet.png";
    }
    private void Clicked(object sender, EventArgs e)
    {
        if (pickerCommand.SelectedItem.Equals("Подсчёт эффективности работника"))
        {
            if (pickerEmployer.SelectedItem != null)
            {
                ...
                string pythonScriptPath = @"D:\BackUp\SalaryCounter\ChartCreate\ChartCreate2.py";
        ...
        if (pickerCommand.SelectedItem.Equals("Подсчёт всех работников"))
        {
            ...
            string pythonScriptPath = @"D:\BackUp\SalaryCounter\ChartCreate\ChartCreate3.py";
            ProcessStartInfo startInfo = new ProcessStartInfo();
            startInfo.FileName = "python";
            startInfo.Arguments = pythonScriptPath;
        ...
        if (pickerCommand.SelectedItem.Equals("Генерация предположительных трудозатрат"))
        {
            ...
            string pythonScriptPath = @"D:\BackUp\SalaryCounter\ChartCreate\ChartCreate4.py";
            ProcessStartInfo startInfo = new ProcessStartInfo();
            startInfo.FileName = "python";
            startInfo.Arguments = pythonScriptPath;
        ...
        if (pickerCommand.SelectedItem.Equals("Генерация предположительных трудозатрат по задаче"))
        {
            if (pickerTask.SelectedItem == null)
            {
                AppShell.Current.DisplayAlert("Генерация", "Выберите задачу", "OK");
            ...
            string pythonScriptPath = @"D:\BackUp\SalaryCounter\ChartCreate\ChartCreate5.py";
            ProcessStartInfo startInfo = new ProcessStartInfo();
            startInfo.FileName = "python";
            startInfo.Arguments = pythonScriptPath;
